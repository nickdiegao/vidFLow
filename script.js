...
async function buscarEMostrarVideos(){
    try {
        ...
        containerVideos.innerHTML = `<p>Houve um erro ao carregar o conteúdo: ${error}</p>`
    }
}
...
const barraDeTarefas = document.querySelectorAll('.superior__item') 

barraDeTarefas.forEach((botao) => {
